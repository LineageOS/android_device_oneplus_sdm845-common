...
int main() {
    LOG(INFO) << "OnePlus SDM845 Power HAL AIDL Service with Extension is starting.";
    ...
    LOG(INFO) << "OnePlus SDM845 Power HAL AIDL Service with Extension is started.";
    ...
    // should not reach
    LOG(ERROR) << "OnePlus SDM845 Power HAL AIDL Service with Extension just died.";
    return EXIT_FAILURE;
}
